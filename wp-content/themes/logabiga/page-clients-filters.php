        ...
        <div class="margin">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb d-flex">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo get_option('home'); ?>/clients/">Клиенты</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Onliner</li>
                </ol>
            </nav>
            <h4 class="tab-clients-filters">Onliner</h4>
