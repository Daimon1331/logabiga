    ...
    <section class="d-flex align-items-center justify-content-center contacts">
        <div class="d-flex flex-column align-items-center">
            ...
            <div class="d-flex justify-content-between icons">
                <a href="#"><img src="<?php echo get_template_directory_uri() ?>/assets/images/instblack.svg"></a>
                <a href="#"><img src="<?php echo get_template_directory_uri() ?>/assets/images/fbblack.svg"></a>
